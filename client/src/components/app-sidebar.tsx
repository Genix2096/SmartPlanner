    ...
    <Sidebar className="border-r border-border/50">
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupLabel className="text-xs font-semibold tracking-wider uppercase text-white mb-2 px-6">
            Menu
          </SidebarGroupLabel>
        ...
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            ...
            <SidebarMenuButton 
              ...
              className="text-red hover:text-destructive hover:bg-destructive/10 px-3 py-2 rounded-lg transition-colors w-full"
            >

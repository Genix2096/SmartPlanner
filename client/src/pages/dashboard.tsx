        ...
        <Card className="rounded-2xl border-none shadow-md bg-gradient-to-br from-indigo-500 to-primary text-primary-foreground">
          ...
          <CardContent>
            ...
            <Progress
              ...
              className="h-2 mt-3 bg-white/20 [&>div]:bg-emerald-400"
            />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-card rounded-2xl border border-border/50 shadow-sm overflow-hidden">
            ...
            {upcomingTasks.length === 0 ? (
              <div className="p-8 text-center text-card-foreground flex flex-col items-center">
        ...
        <div className="space-y-4">
          ...
          <Card className="rounded-2xl border border-border/50 shadow-sm bg-white">
            ...
            <CardContent className="p-6 pt-6 text-card-foreground">

              <div className="h-10 w-10 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-sm leading-relaxed">
                Break your study sessions into 25-minute intervals separated
                by short 5-minute breaks. It improves focus and prevents
                mental fatigue.
              </p>
